...
class TestBombayStockExchange(CommonFinancialTests, TestCase):
    ...
    self.assertLocalizedHolidays(
        "pa",
        ("2023-01-26", "ਗਣਤੰਤਰ ਦਿਵਸ"),
        ("2023-03-07", "ਹੋਲੀ"),
        ("2023-03-30", "ਰਾਮ ਨਵਮੀ"),
        ("2023-04-04", "ਮਹਾਵੀਰ ਜਯੰਤੀ"),
        ("2023-04-07", "ਗੁੱਡ ਫ੍ਰਾਈਡੇ"),
        ("2023-04-14", "ਡਾ. ਬਾਬਾ ਸਾਹਿਬ ਅੰਬੇਡਕਰ ਜਯੰਤੀ"),
        ("2023-05-01", "ਮਹਾਰਾਸ਼ਟਰ ਦਿਵਸ"),
        ("2023-06-28", "ਬਕਰੀਦ"),
        ("2023-08-15", "ਆਜ਼ਾਦੀ ਦਿਵਸ"),
        ("2023-09-19", "ਗਣੇਸ਼ ਚਤੁਰਥੀ"),
        ("2023-10-02", "ਮਹਾਤਮਾ ਗਾਂਧੀ ਜਯੰਤੀ"),
        ("2023-10-24", "ਦਸਹਿਰਾ"),
        ("2023-11-14", "ਦੀਵਾਲੀ ਬਲੀ ਪ੍ਰਤਿਪਦਾ"),
        ("2023-11-27", "ਗੁਰੂ ਨਾਨਕ ਜਯੰਤੀ"),
        ("2023-12-25", "ਕ੍ਰਿਸਮਸ ਦਿਵਸ"),
    )
